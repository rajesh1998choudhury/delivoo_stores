...
class NextDayOrderPage extends StatefulWidget {
  const NextDayOrderPage({Key? key}) : super(key: key);

  @override
  State<NextDayOrderPage> createState() => _NextDayOrderPageState();
}

class _NextDayOrderPageState extends State<NextDayOrderPage> {
  @override
  void initState() {
    context.read<OrderProvider>().getNextDayOrders(
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        onRefresh: () => context.read<OrderProvider>().isLoading
            ...
            : context
                .read<OrderProvider>()
                .getNextDayOrders(toDate: "", fromdate: "", searchText: ""),
