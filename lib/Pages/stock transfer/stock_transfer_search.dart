...
class StockTransferSearch extends SearchDelegate {
  final orderId;
  StockTransferSearch({Key? key, this.orderId});
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) => ListTile(
        ...
        onTap: () async {
          ...
          await context.read<StoreOrderProvider>().returnAvailableStoreItemsApi(
              action: "8", loading: true, itemName: query, qr: "");
          close(context, query);
        },
      ),
