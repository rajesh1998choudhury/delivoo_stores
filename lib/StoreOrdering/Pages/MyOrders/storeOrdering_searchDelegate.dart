import 'package:delivoo_stores/StoreOrdering/Pages/MyOrders/storeOrder_searchDelegate.dart';
...
class MyOrderSeachByFilter extends StatefulWidget {
  const MyOrderSeachByFilter({Key? key}) : super(key: key);

  @override
  State<MyOrderSeachByFilter> createState() => _MyOrderSeachByFilterState();
}

class _MyOrderSeachByFilterState extends State<MyOrderSeachByFilter> {
  @override
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                showSearch(context: context, delegate: MyOrdersSearch());
              },
              child: Container(
                          ...
                          children: [
                            Form(
                              ...
                              child: TextFormField(
                                ...
                                validator: (value) =>
                                    value!.length < 1 ? 'Enter Order No' : null,
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Center(
                          child: Text(
                            context.watch<StoreOrderProvider>().firstDay ??
                                "Select Date",
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          context.watch<StoreOrderProvider>().lastDay ??
                              "Select Date",
                          style: TextStyle(fontSize: 14),
                        ),
                      ],
              ...
              child: ElevatedButton.icon(
                  ...
                  onPressed: () async {
                    await context.read<StoreOrderProvider>().getPastOrders(
                        fromdate:
                            context.read<StoreOrderProvider>().firstDay ?? "",
                        toDate:
                            context.read<StoreOrderProvider>().lastDay ?? "",
                        searchText: null);
                    Navigator.pop(context);
                  },
                  icon: Icon(
